...
function ts_get_icons_array() {
	...
	//You can use this code to retrieve icons preg_match_all('/\.(fa-(?:\w+(?:-)?)+):before{content:/', file_get_contents(get_template_directory().'/css/font-awesome.min.css'), $matches, PREG_SET_ORDER);
