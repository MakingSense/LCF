<?php
/**
 * Template Name: Blog Standard Alternative
 * 
 * @package splendid
*/
get_header();
...
<main id="splendid-main-container" class="blog-container <?php echo (ts_check_if_sidebar_activated() ? 'container-with-sidebar' : '') ?>">
	...
	<!-- Blog Wrapper -->
	<div id="blog-wrapper" class="blog-standard-wrapper <?php echo (ts_check_if_sidebar_activated() ? '' : 'blog-standard-fullwidth') ?> <?php echo sanitize_html_classes(ts_get_post_opt('page-margin-local'));?>">
		<?php if ($the_query -> have_posts()) : ?>
			<?php /* Start the Loop */
			while ($the_query -> have_posts()) : $the_query -> the_post(); ?>
				<?php get_template_part('templates/blog-standard-alt/content',get_post_format()); ?>
			<?php endwhile;
			wp_reset_postdata(); ?>
