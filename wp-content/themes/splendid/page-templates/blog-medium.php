...
<main id="splendid-main-container" class="container page-layout <?php echo (ts_check_if_sidebar_activated() ? 'container-with-sidebar' : '') ?>">
	...
	<div class="main-content <?php echo sanitize_html_classes(ts_get_post_opt('page-margin-local'));?>">
		...
		<!-- Blog Wrapper -->
		<div id="blog-wrapper" class="blog-medium-wrapper <?php echo (ts_check_if_sidebar_activated() ? '' : 'blog-medium-fullwidth') ?>">
			<?php if ($the_query -> have_posts()) : ?>
				<?php /* Start the Loop */
				while ($the_query -> have_posts()) : $the_query -> the_post(); ?>
					<?php get_template_part('templates/blog-medium/content',get_post_format()); ?>
				<?php endwhile;
				wp_reset_postdata(); ?>
