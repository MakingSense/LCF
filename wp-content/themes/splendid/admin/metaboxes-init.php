...
//	$metaboxes[] = ts_redux_get_page_portfolio_metaboxes();
	...
	$metaboxes[] = ts_redux_get_link_post_metaboxes();
	$metaboxes[] = ts_redux_get_quote_post_metaboxes();
...
function ts_redux_get_team_metaboxes() {
	...
	return array(
		...
		'title' => esc_html__('Team Member Options', 'splendid'),
...
function ts_redux_get_testimonial_metaboxes() {
	...
	return array(
		'id' => 'ts-portfolio-options',
		'title' => esc_html__('Testimonial Options', 'splendid'),
...
function ts_redux_get_page_template_blog_metaboxes() {
	...
	return array(
		...
		'title' => esc_html__('Blog Options', 'splendid'),
		...
		'page_template' => array(
			...
			'page-templates/blog-standard-alt.php',
			'page-templates/blog-medium.php',
			'page-templates/blog-medium-alt.php',
...
//		'title' => esc_html__('Portfolio Options', 'splendid'),
//		'post_types' => array('page'),
//		'position' => 'normal', // normal, advanced, side
//		'priority' => 'high', // high, core, default, low
//		'sections' => $sections,
...
//		'title' => esc_html__('FAQ Options', 'splendid'),
//		'post_types' => array('page'),
//		'position' => 'normal', // normal, advanced, side
//		'priority' => 'high', // high, core, default, low
//		'sections' => $sections,
...
//		'title' => esc_html__('Shop Options', 'splendid'),
//		'post_types' => array('page'),
//		'position' => 'normal', // normal, advanced, side
//		'priority' => 'high', // high, core, default, low
//		'sections' => $sections,
...
function ts_redux_get_page_metaboxes() {
	...
	return array(
		'id' => 'ts-page-options',
		'title' => esc_html__('Options', 'splendid'),
		'post_types' => array('page'),
		'position' => 'normal', // normal, advanced, side
		'priority' => 'high', // high, core, default, low
		'sections' => $sections
...
function ts_redux_get_social_site_metaboxes() {
	...
	return array(
		...
		'title' => esc_html__('Post Options', 'splendid'),
...
/**
 * Get configuration array for link post metaboxes
 * @return type
 */
function ts_redux_get_link_post_metaboxes() {
	
	// Variable used to store the configuration array of sections
	$sections = array();
	
	// Metabox used to overwrite theme options by page
	require get_template_directory() . '/admin/metaboxes/post-link.php';
	
	return array(
		'id' => 'ts-link-post-options',
		'title' => esc_html__('Link Post Options', 'splendid'),
...
/**
 * Get configuration array for quote post metaboxes
 * @return type
 */
function ts_redux_get_quote_post_metaboxes() {
	
	// Variable used to store the configuration array of sections
	$sections = array();
	
	// Metabox used to overwrite theme options by page
	require get_template_directory() . '/admin/metaboxes/post-quote.php';
	
	return array(
		'id' => 'ts-quote-post-options',
		'title' => esc_html__('Quote Post Options', 'splendid'),
		'post_types' => array('post'),
		'position' => 'normal', // normal, advanced, side
		'priority' => 'high', // high, core, default, low
		'sections' => $sections,
...
function ts_redux_get_video_post_metaboxes() {
	...
	return array(
		...
		'title' => esc_html__('Video Post Options', 'splendid'),
		'post_types' => array('post'),
		'position' => 'normal', // normal, advanced, side
		'priority' => 'high', // high, core, default, low
		'sections' => $sections,
...
function ts_redux_get_gallery_post_metaboxes() {
	...
	return array(
		...
		'title' => esc_html__('Gallery Post Options', 'splendid'),
		'post_types' => array('post'),
		'position' => 'normal', // normal, advanced, side
		'priority' => 'high', // high, core, default, low
		'sections' => $sections,
...
function ts_redux_get_portfolio_metaboxes() {
	...
	require get_template_directory() . '/admin/metaboxes/portfolio-settings.php';
 	require get_template_directory() . '/admin/metaboxes/preheader.php';
 	require get_template_directory() . '/admin/metaboxes/header.php';
	require get_template_directory() . '/admin/metaboxes/title-wrapper-portfolio.php';
	require get_template_directory() . '/admin/metaboxes/content-portfolio.php';
	require get_template_directory() . '/admin/metaboxes/footer.php';
...
function ts_redux_get_audio_post_metaboxes() {
	...
	return array(
		...
		'title' => esc_html__('Audio Post Options', 'splendid'),
		'post_types' => array('post'),
		'position' => 'normal', // normal, advanced, side
		'priority' => 'high', // high, core, default, low
		'sections' => $sections,
