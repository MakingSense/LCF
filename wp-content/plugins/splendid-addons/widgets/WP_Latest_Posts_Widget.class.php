...
class splendid_WP_Latest_Posts_Widget extends WP_Widget
{
	function __construct()
	{
		$widget_ops = array('classname' => 'widget_latest_posts_entries', 'description' => esc_html__( "Displays the most latest posts", 'splendid-addons' ) );
		parent::__construct('latest-posts', esc_html__( 'Splendid: Latest Posts', 'splendid-addons' ), $widget_ops);
